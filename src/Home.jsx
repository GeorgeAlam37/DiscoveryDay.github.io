...
function Home() {
  ...
  <div className="row">
    ...
    <div className="col-md-5 d-flex align-items-center justify-content-center text-center text-md-start my-4">
      <div>
        <h2 className="fw-bold fs-42 mb-4">Untapp your<br />talent and learn<br />for free ✨</h2>
    ...
    <HowItWorks />
    {/* kick start div */}
  <div className="d-flex justify-content-center align-items-center kick-start py-5">
  <div className="container text-center">
    <div className="row">
      ...
      <div className="col-md-6">
        ...
        <Link to="/register" onClick={goUp}>
          <button className="btn btn-outline-dark btn-md mt-3 fw-bold">Sign up for our Discovery Day 🎉</button>
        </Link>
